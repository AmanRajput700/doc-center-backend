...
const { documentUploadValidator, paramIdValidator, folderCreateValidator } = require('../validators/documentValidator');
...
router.get('/:id/view-url', verifyToken, authorize('view_document'), asyncHandler(async function _getPresignedViewUrl(req, res, next) {
    const tenant = req.tenant;
...
router.delete('/:id/document', verifyToken, authorize('delete_document'), asyncHandler(async function _deleteDocument(req, res, next) {
    const docId = req.params.id;
...
router.delete('/:id/folder', verifyToken, authorize('delete_document'), asyncHandler(async function _deleteFolder(req, res, next) {
...
router.put('/:id/document', verifyToken, authorize('update_document'), asyncHandler(async function _updateDocument(req, res, next) {
    const docId = req.params.id;
    const data = req.body;
